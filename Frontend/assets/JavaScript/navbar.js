document.addEventListener('DOMContentLoaded', function () {
    ...
    if (isAdmin) {
        ...
        adminSection.innerHTML = `
            <a id="navbarAdmin" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Admin" class="icon" id="adminText" href="./Frontend/assets/pages/admin.html" style="color: black;">
                <small>Admin</small>
