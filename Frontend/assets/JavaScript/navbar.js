document.addEventListener('DOMContentLoaded', function () {
    ...
    if (isAdmin) {
        ...
        adminSection.innerHTML = `
            <a id="navbarAdmin" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Admin" class="icon" id="adminText" href="./Frontend/assets/pages/agregar-zapato.html" style="color: black;">
                <small>Admin</small>
        ...
        if(!document.querySelector(".banner")) {
            ...
            enlaceAdminSection.href = "../pages/agregar-zapato.html"; 
        }
